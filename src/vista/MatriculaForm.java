...
public class MatriculaForm extends javax.swing.JFrame {
    ...
    private void tbdatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbdatosMouseClicked
        ...
        if(fila>=0){
            ...
            txtapellido.setText(""+tbdatos.getValueAt(fila, 2));
            txtcarrera.setText(""+tbdatos.getValueAt(fila, 3));
            txtciclo.setText(""+tbdatos.getValueAt(fila, 4));
            txtfecha.setText(""+tbdatos.getValueAt(fila, 5));
            txtmodalidad.setText(""+tbdatos.getValueAt(fila, 6));
        }
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        if(fila>=0){
            ...
            limpiar();
            llenardatos();
            JOptionPane.showMessageDialog(rootPane, "Matricula eliminada correctamente");
        }else{
        ...
        private void llenardatos(){
            ...
            for(int j=0; j<lista.size(); j++){
                ...
                fila[2] = lista.get(j).getApellido();
                fila[3] = lista.get(j).getCarrera();
                fila[4] = lista.get(j).getCiclo();
                fila[5] = lista.get(j).getFecha();
                fila[6] = lista.get(j).getModalidad();
                model.addRow(fila);
            }
    ...
    private void btnactualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnactualizarActionPerformed
        ...
        if(fila>=0){
            ...
            p.setCiclo(Integer.parseInt(txtciclo.getText()));
            p.setNombre(txtnombre.getText());
            p.setFecha(txtfecha.getText());
            p.setModalidad(txtmodalidad.getText());
            p.setCarrera(txtcarrera.getText());
            dao.update(fila, p);
            limpiar();
            llenardatos();
            JOptionPane.showMessageDialog(rootPane, "Matricula modificada exitosamente");
        }else{
            JOptionPane.showMessageDialog(rootPane, "Seleccionar Fila");
        }
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        if(!txtnombre.getText().equals("") && !txtapellido.getText().equals("") && !txtciclo.getText().equals("") && !txtcarrera.getText().equals("") && !txtfecha.getText().equals("") && !txtmodalidad.getText().equals("")){
            Matricula p = new Matricula();
            p.setApellido(txtapellido.getText());
            p.setCiclo(Integer.parseInt(txtciclo.getText()));
            p.setNombre(txtnombre.getText());
            ...
            dao.add(p);
            limpiar();
            JOptionPane.showMessageDialog(rootPane, "Matricula guardada exitosamente");
        }else{
